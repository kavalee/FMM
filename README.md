...
# Performance
This implementation using the number of levels used to be max(log2(n), 2). Also included are some graphs of number of levels being log2(n) just because it is interesting.
